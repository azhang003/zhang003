...
//        }
        ...
        foreach ($adress as $ADRESS) {
            queue(queueRecharge::class, ['task' => 'tronIntegrationFromUser', 'data' => [
                'mid' => $ADRESS->mid,
                'address' => $ADRESS->trc_address,
                'privateKey' => $ADRESS->trc20_pv,
                'collect_mix' => $collect_mix]], 0, 'tronIntegrationFromUser');
        }
        /*** 这里写计划任务列表集 END ***/
