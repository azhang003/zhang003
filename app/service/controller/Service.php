...
class Service
{
    ...
    public function banner()
    {
        $data = [
            ...
            [
                "url" => "https://service.newnnb.vip/banner.png",
                'image' => "https://service.newnnb.vip/upload/001.png",
                "text" => "测试"
            ],
            [
                "url" => "https://service.newnnb.vip/banner.png",
                'image' => "https://service.newnnb.vip/upload/002.png",
                "text" => "测试"
            ],
            [
                "url" => "https://service.newnnb.vip/banner.png",
                'image' => "https://service.newnnb.vip/upload/003.png",
                "text" => "测试"
            ]
        ];
        return success($data);
